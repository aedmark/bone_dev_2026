...
class TestArchetypes(BoneTestCase):
    def setUp(self):
        super().setUp()
        self.chaotic_config = {
            "VILLAGE": {"TOWN_NEGLECT_CRIT": "8.0", "TOWN_TRAUMA_CRIT": "0.6", "TOWN_HEALTH_CRIT": "30.0",
                        "DEATH_TRAUMA_CRIT": "50.0", "DEATH_TOXICITY_CRIT": "5.0", "THERAPY_TRAUMA_THRESH": "15.0",
    ...
    def test_townhall_string_trauma_vector(self):
        session_data = {
            "trauma_vector": {"papercut": "9.0", "decapitation": "10.0"}, "meta": {"final_health": "25.0"}}
    ...
    def test_council_audit_string_physics(self):
        ...
        loose_physics = {"voltage": "110.0", "narrative_drag": "0.0", "stamina": "100.0", "i_c": "0.1"}
