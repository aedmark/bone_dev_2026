...
class TheAkashicRecord:
    ...
    def _on_mythology_update(self, payload):
        ...
        if "physics" in payload:
            ...
            valid_resonance = next((r for r in resonances if r.get("trigram") == trigram and r.get("lens", r.get("soul")) == active_lens), None)
    ...
    def _crystallize_recipe(self, ingredient, catalyst, result_item):
        ...
        if not any(r.get("ingredient") == ingredient and r.get("catalyst_category") == catalyst for r in current_recipes):
