...
class BoneConfig:
    ...
    def _load_class_defaults(cls):
        """Dynamically loads configuration dictionaries from Lore directly to the CLASS level."""
    ...
    def __init__(self):
        # Deep clone class-level ConfigNodes to instance-level.
        # This ensures `load_preset` safely mutates only this specific engine instance,
        # without bleeding into the global class defaults during testing.
...
# Inject defaults into the class globally upon module load.
